...
```
┌── contracts/ ── the shared truth: 61 metrics, 12 widgets, 9 presets, golden fixtures ──┐
│                                                                                         │
...
| `docs/` | [Architecture](docs/ARCHITECTURE.md) · [Data sources](docs/DATA_SOURCES.md) · [Legal](docs/LEGAL.md) · [Runbook](docs/RUNBOOK.md) |
...
Two codebases in two languages have to agree on 61 metric definitions, 12 payload shapes and 9
